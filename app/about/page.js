    ...
    <main className="public-page">
      ...
      <section className="public-section">
        <div className="section-introduction">
          ...
          <h2>A customer-focused banking experience.</h2>
      ...
      <section className="about-values">
        <div className="about-value-intro">
          ...
          <h2>Simple, accessible and customer focused.</h2>
      ...
      <section className="public-section">
        <div className="section-heading">
          <div>
            ...
            <h2>Banking resources for everyday needs.</h2>
          </div>
        </div>
      ...
      <section className="bank-information">
        <div className="bank-information-content">
          <span className="section-label">BANK INFORMATION</span>
      ...
      <section className="security-public">
        ...
        <div>
          ...
          <h2>Protect your account information.</h2>
      ...
      <section className="final-cta">
        ...
        <h2>Explore your banking options.</h2>
